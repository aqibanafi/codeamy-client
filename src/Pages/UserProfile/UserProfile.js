                ...
                <div>
                    ...
                    <div className="space-y-4 text-center divide-y divide-gray-700">
                        ...
                        <div className="flex justify-center pt-2 space-x-4 align-center">
                            ...
                            <Link rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-2 rounded-md text-amber-500 hover:text-amber-700">
                            ...
                            <Link rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md text-amber-500 hover:text-amber-700">
                                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                            ...
                            <Link rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md text-amber-500 hover:text-amber-700">
                                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
